      ...
      <div class="wrapper">
        <div class="m_wrap">
          <div class="nav">
            ...
            <a href="http://devicelab.fi/" class="button">Go to front page</a>
          </div>
        </div>
        <h2><span>404 Error. The page you've requested cannot be found. Go to <a href="http://devicelab.fi/">front page</a> or try checking the URL for errors, and then hit the refresh button on your browser.</span></h2>
      </div>
    </div>
